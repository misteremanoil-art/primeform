...
const cards = [
  {
    ...
    body:
      "You train regularly, but you do not know whether your programme is moving you towards your actual goal.",
    ui: <BrokenWeek />,
  },
  {
    icon: TriangleAlert,
    title: "Unsustainable nutrition",
    body:
      "You follow strict rules for a few days, lose control and feel like you need to start again.",
    ui: <BrokenNutrition />,
  },
  {
    icon: Unplug,
    ...
    body:
      "When progress slows down, there is nobody reviewing the data or helping you make the next adjustment.",
...
export function ProblemSection() {
  return (
    <section className="container-p section">
      <SectionHeader eyebrow="Why most plans fail" title="You probably do not need more motivation. You need a system you can actually follow.">
        Most people are not failing because they are lazy. They are failing because
        their training changes every week, their nutrition feels impossible to
        maintain and nobody is helping them adjust when life gets in the way. A good
        coaching system removes the guesswork.
      </SectionHeader>
