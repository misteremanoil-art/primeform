...
export function StatsPanel({
  ...
  return (
    ...
    >
        ...
        <div className="flex-1 space-y-4">
          ...
          <div>
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-sm font-medium text-muted">weeks</span>
      ...
      {/* Consistency */}
      <div className="mt-6">
        <p className="eyebrow mb-2.5">Workout consistency</p>
      ...
      <div className="surface-card mt-5 flex items-center gap-3 p-4">
        <div className="min-w-0 flex-1">
          ...
          <p className="tnum text-xs text-muted">
            {seedWorkout.exercises.length} exercises · {seedWorkout.durationMin} min
          </p>
        </div>
        <Link
          href={startHref}
