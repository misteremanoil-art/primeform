...
export const FluidParticlesBackground = ({
  ...
  // Stable noise instance — recreating it every render would restart the loop.
  ...
  useEffect(() => {
    ...
    const animate = (now: number) => {
      ...
      // Skip all work while the tab is backgrounded or between throttled frames.
      ...
      // Semi-transparent fill creates the fading motion trails.
  ...
  return (
    <div
      className={cn(
        "relative h-screen w-full overflow-hidden bg-bg",
        className,
      )}
    >
